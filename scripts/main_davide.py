...
bayes_opt1 = BayesOptimizer(patient1, niter=20, k=4, T=450)
nu1, mod1 = bayes_opt1.optimize()

# patient 2
patient2 = np.array(patients[1])
bayes_opt2 = BayesOptimizer(patient2, niter=20, k=4, T=450)
nu2, mod2 = bayes_opt2.optimize()

# patient 3
patient3 = np.array(patients[2])
bayes_opt3 = BayesOptimizer(patient3, niter=20, k=4, T=450)
